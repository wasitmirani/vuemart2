  ...
  <div>
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-6 col-12 mb-2 mb-md-0">
                <div class="media">
                  ...
                  <div class="media-body my-auto">
                    <h4 class="font-weight-bolder mb-0">
                      {{ this.staticList.adminusers }}
                    </h4>
                    <p class="card-text font-small-3 mb-0">Admin Users</p>
                  </div>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-12 mb-2 mb-sm-0">
                <div class="media">
                  ...
                  <div class="media-body my-auto">
                    <h4 class="font-weight-bolder mb-0">
                      {{ this.staticList.customerusers }}
                    </h4>
                    <p class="card-text font-small-3 mb-0">Customer Users</p>
                  </div>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-12">
                <router-link to="/trashed/users">
                  <div class="media">
                    ...
                    <div class="media-body my-auto">
                      <h4 class="font-weight-bolder mb-0">
                        {{ this.staticList.mangerusers }}
                      </h4>
                      <p class="card-text font-small-3 mb-0">Manager Users</p>
                    </div>
                  </div>
                </router-link>
              </div>
    ...
    <div class="row" id="table-hover-animation">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title" v-can="'UsersRead'">Users List</h4>
          </div>
          <div class="card-body">
      ...
      <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" v-if="!editMode">Create New User</h4>
...
export default {
  ...
  methods: {
    ...
    getusers(page = 1) {
      ...
      axios
        .get(
          this.$hostapi_url + "/user?page=" + page + "&query=" + this.query,
          this.$config
        )
        .then((res) => {
    ...
    deleteData(item) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios
            .delete(this.$hostapi_url + "/user/" + item.id, this.$config)
            .then((res) => {
              this.getusers();
