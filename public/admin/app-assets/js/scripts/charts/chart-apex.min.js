$(function() {
            ...
            var e = $(".flat-picker"),
                ...
                t = { series1: "#ffe700", series2: "#00d4bd", series3: "#826bf8", series4: "#2b9bf4", series5: "#FFA1A1" },
            ...
            var l = document.querySelector("#column-chart"),
                d = {
                    ...
                    plotOptions: { bar: { columnWidth: "15%", colors: { backgroundBarColors: [o.bg, o.bg, o.bg, o.bg, o.bg], backgroundBarRadius: 10 } } },
                    dataLabels: { enabled: !1 },
                    legend: { show: !1 },
            ...
            var c = document.querySelector("#scatter-chart"),
                h = {
                    chart: { height: 400, type: "scatter", zoom: { enabled: !0, type: "xy" }, toolbar: { show: !1 } },
                    grid: { xaxis: { lines: { show: !0 } } },
                    legend: { show: !1 },
            ...
            var p = document.querySelector("#line-chart"),
                m = {
                    chart: { height: 400, type: "line", zoom: { enabled: !1 }, toolbar: { show: !1 } },
            ...
            var v = document.querySelector("#radar-chart"),
                k = {
                    chart: { height: 400, type: "radar", toolbar: { show: !1 }, dropShadow: { enabled: !1, blur: 8, left: 1, top: 1, opacity: 0.2 } },
                    legend: { show: !1 },
                    yaxis: { show: !1 },
                    series: [
            ...
            var D = document.querySelector("#donut-chart"),
                C = {
                    ...
                    responsive: [
                        { breakpoint: 992, options: { chart: { height: 380 }, legend: { position: "bottom" } } },
                        {
                            breakpoint: 576,
                            options: { chart: { height: 320 }, plotOptions: { pie: { donut: { labels: { show: !0, name: { fontSize: "1.5rem" }, value: { fontSize: "1rem" }, total: { fontSize: "1.5rem" } } } } }, legend: { show: !1 } },
                        },
