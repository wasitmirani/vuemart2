$(window).on("load", function() {
    ...
    var o,
        ...
        w = "#EBEBEB",
        p = "#b9b9c3",
        u = document.querySelector("#stics-ostatirder-chart"),
    ...
    // setTimeout(function() {
    //         toastr.success("You have successfully logged in to Vuexy. Now you can start to explore!", "👋 Welcome John Doe!", { closeButton: !0, tapToDismiss: !1 });
    //     }, 2e3),
    (o = {
